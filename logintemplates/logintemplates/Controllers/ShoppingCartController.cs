...
namespace logintemplates.Controllers
{
    ...
    {
        IsmtdbEntities storeDB = new IsmtdbEntities();
        // 
        // GET: /ShoppingCart/ 
        [Authorize]
        ...
        public ActionResult RemoveFromCart(int id)
        {
            ...
            // Get the name of the album to display confirmation 
            string albumName = storeDB.Carts.Single(item => item.RecordId == id).tblproduct.ProductName;
        ...
        public ActionResult AddressAndPayment(OrderViewModel ovm)
        {
            ...
            List<Cart> lst = cart.GetCartItems();
